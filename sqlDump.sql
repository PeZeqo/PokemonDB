...
INSERT INTO `battles` VALUES (1,1,2,0,250),(2,2,3,1,100),(3,4,1,0,500),(4,3,4,0,300),(5,1,2,1,200),(6,1,4,0,400);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `transfer_trainer_money` AFTER INSERT ON `battles` FOR EACH ROW BEGIN
	UPDATE Trainer
...
CREATE TABLE `capturedpokemon` (
  `capt_pokemon_id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `trainer` VALUES (1,'Peter',300,'Lavendar Town',1),(2,'Ryan',500,'Cinnabar Island',1),(3,'Oak',52500,'Pallet Town',1),(4,'Giovani',999900,'Cerulian Cave',3);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `forget_move_by_id`(IN cpt_pk_id INT, IN mv_id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `forget_move_by_name`(IN cpt_pk_id INT, IN move_name VARCHAR(50))
BEGIN
	DELETE FROM learnedmoves 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `learn_move_by_id`(IN cpt_pk_id INT, IN move_id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `learn_move_by_name`(IN cpt_pk_id INT, IN move_name VARCHAR(50))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `move_trainer`(IN tr_id INT, IN new_loc VARCHAR(50))
BEGIN
...
-- Dump completed on 2021-04-20 21:48:45
